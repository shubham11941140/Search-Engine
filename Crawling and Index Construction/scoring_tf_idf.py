...
def main():
    ...
    for query in queries:
        ...
        print("The results for query:", query, "are docids (sorted):",
              sorted(result))

        # Print the average time of execution for the solver function
        print(
            "The Execution time for query:",
            query,
            "by computing the TF-IDF score when averaged to 100 iterations (in seconds) is:",
            execute_100(query, result, alldocs),
        )
